...
<p align="center">
  <img src="screenshots/preview.png" alt="fract'ol preview" width="720"/>
</p>
...
![Bonus fractal](screenshots/bonus_fractal.png)
![Color shift](screenshots/color_shift.png)
...
- [GCC Auto-vectorization](https://gcc.gnu.org/onlinedocs/gcc/Optimize-Options.html) — Compiler flags for automatic vectorization (`-O3`, `-march=native`).
...
Claude Opus 4.6 and Gemini were used to build initial understanding of the project requirements and scope.

### Learning — Gemini Teaching Mode
...
**No code was directly generated by AI in the project. No code was directly generated by AI in this project. I strongly advise against using AI directly for code generation in a school project.**
